...
public class OrderMainController extends BaseController
{
     ...
     * 导出订单/任务主列表
     */
    //@PreAuthorize("@ss.hasPermi('business:main:export')")
     ...
     * 获取订单/任务主详细信息
     */
    //@PreAuthorize("@ss.hasPermi('business:main:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增订单/任务主
     */
    //@PreAuthorize("@ss.hasPermi('business:main:add')")
     ...
     * 修改订单/任务主
     */
    //@PreAuthorize("@ss.hasPermi('business:main:edit')")
     ...
     * 删除订单/任务主
     */
    //@PreAuthorize("@ss.hasPermi('business:main:remove')")
