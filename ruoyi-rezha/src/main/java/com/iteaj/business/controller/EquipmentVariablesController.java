...
public class EquipmentVariablesController extends BaseController
{
     ...
     * 查询存储设备变量参数信息的列表
     */
    //@PreAuthorize("@ss.hasPermi('deviceInfo:variables:list')")
    @GetMapping("/list")
     ...
     * 导出存储设备变量参数信息的列表
     */
    //@PreAuthorize("@ss.hasPermi('deviceInfo:variables:export')")
     ...
     * 获取存储设备变量参数信息的详细信息
     */
    //@PreAuthorize("@ss.hasPermi('deviceInfo:variables:query')")
     ...
     * 新增存储设备变量参数信息的
     */
    //@PreAuthorize("@ss.hasPermi('deviceInfo:variables:add')")
     ...
     * 修改存储设备变量参数信息的
     */
    //@PreAuthorize("@ss.hasPermi('deviceInfo:variables:edit')")
     ...
     * 删除存储设备变量参数信息的
     */
    //@PreAuthorize("@ss.hasPermi('deviceInfo:variables:remove')")
