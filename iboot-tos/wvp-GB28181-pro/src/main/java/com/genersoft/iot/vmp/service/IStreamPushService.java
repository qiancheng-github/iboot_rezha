 ...
 * @author lin
 */
public interface IStreamPushService extends IService<StreamPushItem> {
     ...
     * 获取
     */
    Page<StreamPushItem> getPushList(Page page, String query, Boolean pushing, String mediaServerId);
    ...
    boolean deleteByAppAndStream(String app, String stream);
}
